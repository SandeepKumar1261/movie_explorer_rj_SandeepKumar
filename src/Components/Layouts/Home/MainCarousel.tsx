...
const MainCarousel: React.FC = () => {
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Button 
              ...
              color="primary" 
              startIcon={<span>▶</span>}
              sx={{fontSize:{xs: 1, md: 3 }, px: { xs: 2, md: 3 }, py: { xs: 1, md: 1.5 } }}
            >
              Watch Now
            </Button>
            <Button 
              variant="outlined" 
              sx={{ color: 'white', borderColor: 'white', px: { xs: 2, md: 3 }, py: { xs: 1, md: 1.5 } }}
            >
              + Watchlist
            </Button>
          </Stack>
      ...
      >
        {["NETFLIX", "DISNEY+", "prime video", "Vidio", "Apple TV+", "viu"].map((service) => (
          <Box
            key={service}
            sx={{
              backgroundColor: '#333',
